...
static bool raycart_SaveFileData(wasm_exec_env_t exec_env, const char * fileName, const void * data, int dataSize) {
...
static unsigned int raycart_GetDirectoryFileCount(wasm_exec_env_t exec_env, const char * dirPath) {
    return GetDirectoryFileCount(dirPath);
}

static unsigned int raycart_GetDirectoryFileCountEx(wasm_exec_env_t exec_env, const char * basePath, const char * filter, bool scanSubdirs) {
...
static unsigned int raycart_ComputeCRC32(wasm_exec_env_t exec_env, const unsigned char * data, int dataSize) {
    return ComputeCRC32(data, dataSize);
}

static unsigned int * raycart_ComputeMD5(wasm_exec_env_t exec_env, const unsigned char * data, int dataSize) {
    return ComputeMD5(data, dataSize);
}

static unsigned int * raycart_ComputeSHA1(wasm_exec_env_t exec_env, const unsigned char * data, int dataSize) {
...
static void raycart_DrawCircleGradient(wasm_exec_env_t exec_env, Vector2* center, float radius, Color* inner, Color* outer) {
...
static void raycart_DrawTriangleGradient(wasm_exec_env_t exec_env, Vector2* v1, Vector2* v2, Vector2* v3, Color* c1, Color* c2, Color* c3) {
...
static void raycart_GetSplinePointBezierQuadratic(wasm_exec_env_t exec_env, Vector2* __result, Vector2* p1, Vector2* c2, Vector2* p3, float t) {
    *__result = GetSplinePointBezierQuadratic(*p1, *c2, *p3, t);
}
...
static void raycart_ImageColorContrast(wasm_exec_env_t exec_env, Image * image, int contrast) {
...
static void raycart_ImageDrawRectangleLines(wasm_exec_env_t exec_env, Image * dst, int posX, int posY, int width, int height, Color* color) {
    ImageDrawRectangleLines(dst, posX, posY, width, height, *color);
}

static void raycart_ImageDrawRectangleLinesEx(wasm_exec_env_t exec_env, Image * dst, Rectangle* rec, int thick, Color* color) {
...
static void raycart_ImageDrawTriangleGradient(wasm_exec_env_t exec_env, Image * dst, Vector2* v1, Vector2* v2, Vector2* v3, Color* c1, Color* c2, Color* c3) {
...
static void raycart_MeasureTextCodepoints(wasm_exec_env_t exec_env, Vector2* __result, Font* font, uint32_t codepoints, int length, float fontSize, float spacing) {
        int * codepoints_native = (int *)wasm_runtime_addr_app_to_native(module_inst, codepoints);
    *__result = MeasureTextCodepoints(*font, codepoints_native, length, fontSize, spacing);
}
...
static char * raycart_TextReplaceAlloc(wasm_exec_env_t exec_env, const char * text, const char * search, const char * replacement) {
    return TextReplaceAlloc(text, search, replacement);
}

static char * raycart_TextReplaceBetweenAlloc(wasm_exec_env_t exec_env, const char * text, const char * begin, const char * end, const char * replacement) {
...
static char * raycart_TextInsertAlloc(wasm_exec_env_t exec_env, const char * text, const char * insert, int position) {
...
static void raycart_DrawCylinderWiresEx(wasm_exec_env_t exec_env, Vector3* startPos, Vector3* endPos, float startRadius, float endRadius, int slices, Color* color) {
    DrawCylinderWiresEx(*startPos, *endPos, startRadius, endRadius, slices, *color);
}

static void raycart_DrawCapsule(wasm_exec_env_t exec_env, Vector3* startPos, Vector3* endPos, float radius, int rings, int slices, Color* color) {
    DrawCapsule(*startPos, *endPos, radius, rings, slices, *color);
}

static void raycart_DrawCapsuleWires(wasm_exec_env_t exec_env, Vector3* startPos, Vector3* endPos, float radius, int rings, int slices, Color* color) {
...
static void raycart_UpdateModelAnimationEx(wasm_exec_env_t exec_env, Model* model, ModelAnimation* animA, float frameA, ModelAnimation* animB, float frameB, float blend) {
...
static void raycart_UpdateSound(wasm_exec_env_t exec_env, Sound* sound, const void * data, int frameCount) {
...
#define raycart_native_symbols_count 567
static NativeSymbol raycart_native_symbols[raycart_native_symbols_count] = {
    ...
    {"GetDirectoryFileCount", raycart_GetDirectoryFileCount, "($)i"},
    {"GetDirectoryFileCountEx", raycart_GetDirectoryFileCountEx, "($$i)i"},
    ...
    {"DrawCircleGradient", raycart_DrawCircleGradient, "(*f**)"},
    ...
    {"DrawTriangleGradient", raycart_DrawTriangleGradient, "(******)"},
    ...
    {"GetSplinePointBezierQuadratic", raycart_GetSplinePointBezierQuadratic, "(****f)"},
    ...
    {"ImageColorContrast", raycart_ImageColorContrast, "(*i)"},
    ...
    {"ImageDrawRectangleLines", raycart_ImageDrawRectangleLines, "(*iiii*)"},
    {"ImageDrawRectangleLinesEx", raycart_ImageDrawRectangleLinesEx, "(**i*)"},
    {"ImageDrawTriangle", raycart_ImageDrawTriangle, "(*****)"},
    {"ImageDrawTriangleGradient", raycart_ImageDrawTriangleGradient, "(*******)"},
    ...
    {"MeasureTextCodepoints", raycart_MeasureTextCodepoints, "(**iiff)"},
    ...
    {"TextReplaceAlloc", raycart_TextReplaceAlloc, "($$$)$"},
    {"TextReplaceBetweenAlloc", raycart_TextReplaceBetweenAlloc, "($$$$)$"},
    {"TextInsert", raycart_TextInsert, "($$i)$"},
    {"TextInsertAlloc", raycart_TextInsertAlloc, "($$i)$"},
    ...
    {"UpdateModelAnimationEx", raycart_UpdateModelAnimationEx, "(**f*ff)"},
